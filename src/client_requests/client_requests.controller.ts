...
export class ClientRequestsController {
  ...
  getByDriverAssigned(@Param('id_driver') id_driver: number) {
    return this.clientRequestsService.getByDriverAssigned(id_driver);
  }

  @Get('client/assigned/:id_client')
  getByClientAssigned(@Param('id_client') id_client: number) {
  ...
  updateDriverAssigned(
    @Body() driverAssigned: UpdateDriverAssignedClientRequestDto,
  ) {
